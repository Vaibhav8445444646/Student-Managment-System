...
public class StudentController {
	...
	public StudentController(StudentService studentService, EnrollmentService enrollmentService, ModelMapperConfig modelMapperConfig) {
	...
	public String getStudentById(@PathVariable Long id, Model model) {
		...
		EnrollmentSummaryDTO enrollmentDetails = enrollmentService.findEnrolledStudentCourseDetails(id);
		model.addAttribute("student", student);
		model.addAttribute("enrollmentDetails", enrollmentDetails);
	...
	public String deleteStudent(@PathVariable Long id, RedirectAttributes redirectAttributes) {
		log.info("Post /delete - delete student request received");
		
		studentService.deleteStudent(id);
		redirectAttributes.addAttribute("message", "Student is deleted successfully!!");
