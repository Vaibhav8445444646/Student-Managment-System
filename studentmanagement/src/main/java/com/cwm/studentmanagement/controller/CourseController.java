...
public class CourseController {
	...
	public String deleteCourse(@PathVariable Long id, RedirectAttributes redirectAttributes) {
		log.info("Post /{id}/delete - delete course request received. {}", id);
		
		courseService.deleteCourse(id);
		redirectAttributes.addAttribute("message", "Course is deleted successfully!!");
		
		log.info("Post /{id}/delete - deleted course successfully.");
	...
	public String searchCourse(@RequestParam String name, Model model) {
		log.info("Get /search - searching for course with name: {}", name);
		
		if (name != null && !name.trim().isEmpty() && !"N/A".equals(name)) {
			...
			// If name is N/A or empty, show all courses
			model.addAttribute("courses", courseService.getAllCourses());
			model.addAttribute("searchTerm", "All Courses");
		}
