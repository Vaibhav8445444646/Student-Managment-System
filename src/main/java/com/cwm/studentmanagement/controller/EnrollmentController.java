...
public class EnrollmentController {
	...
	@PostMapping("/{enrollmentId}/delete")
	public String deleteEnrollment(@PathVariable Long enrollmentId, RedirectAttributes redirectAttributes) {
		log.info("Post /{}/delete - delete enrollment request received", enrollmentId);
		
		enrollmentService.deleteEnrollment(enrollmentId);
		redirectAttributes.addAttribute("message", "Enrollment is deleted successfully!!");
		
		log.info("Post /{}/delete - deleted enrollment successfully", enrollmentId);
